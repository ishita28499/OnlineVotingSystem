                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="story-caption">
                            ...
                            <h3>Admin View Voted Users Page</h3>
                            <p class="story1">
                                ...
                                try {
                                    ...
                                    $obj = new DBClass();
                                    $con = $obj->connect();
                                    $sql = "SELECT * FROM usertable WHERE userid  IN (SELECT userid FROM votingtable)";
                                    ...
                                    if ($result->num_rows > 0) {
                                        /* echo "<table>";
                                          ...
                                          echo "<th style='border:1px solid black;'>Phone Num</th>";
                                          echo "<th style='border:1px solid black;'>Email Id</th>";
                                          echo "<th style='border:1px solid black;'>Aadhar Num</th>";
                                          echo "<th style='border:1px solid black;'>Blood Group</th>";
                                          echo "<th style='border:1px solid black;'>Staff Type</th>";

                                          echo "</tr>";
                                          while ($row = $result->fetch_assoc()) {
                                          echo "<tr  style='border:1px solid black;'>";
                                          echo "<td style='border:1px solid black;'>" . $row["StaffId"] . "</td>";
                                          ...
                                          echo "<td style='border:1px solid black;'>" . $row["PhoneNumber"] . "</td>";
                                          echo "<td style='border:1px solid black;'>" . $row["Email"] . "</td>";
                                          echo "<td style='border:1px solid black;'>" . $row["Aadhar"] . "</td>";
                                          echo "<td style='border:1px solid black;'>" . $row["BloodGroup"] . "</td>";
                                          echo "<td style='border:1px solid black;'>" . $row["StaffType"] . "</td>";
                                          //echo "<td><img src='assets/img/" . $row["FileName"] . "' width='100px' height='100px'/></td>";
                                          echo "</tr>";
                                          } */
