...
?>
     ...
     <section class="contact-section">
            <div class="container">
                            <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">New Party Page</h2>
                        <?PHP
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form" action="AddNewParty.php" method="post">
                            <div class="row">
                                <!-- <div class="col-12">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="partyname" id="partyname" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Party Name'" placeholder="Enter Party Name">
                                    </div>
                                </div>
                                
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input class="form-control valid" name="presidentname" id="presidentname" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter President Name'" placeholder="Enter President Name">
                                    </div>
                                </div>                                
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <input class="form-control" name="members" id="members" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Members'" placeholder="Enter Members">
                                    </div>
                                </div>
                                ...
                                <div class="col-6">
                                    <div class="form-group">
                                        <input class="form-control" name="lname" id="phnum" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Login Name'" placeholder="Enter Login Name">
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn">New Party</button>
                            </div>
                        </form>
                    </div>
