...
?>
     ...
     <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                        <h2 class="contact-title">User Login Page</h2>
                        <?PHP
                    ...
                    <div class="col-lg-8">
                        <form class="form-contact contact_form"  method="post"  action="UserLoginCheck.php">
                            <div class="row">
                                <div class="col-sm-12">
                            ...
                            <div class="form-group mt-3">
                                <button type="submit" class="button button-contactForm boxed-btn">User Login</button>
                            </div>
                        </form>
                    </div>
                </div>
